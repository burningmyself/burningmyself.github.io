...
![gitusual](../img/gitusual-6.gif)

如果你想把多个提交融合到一起以便得到清晰的提交历史，那也没有问题！

![gitusual](../img/gitusual-7.gif)
